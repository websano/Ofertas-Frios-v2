<?php
	...
	if(strlen($preco) < 5){
		...
		$style_cent = 'font-size:50px;position:absolute;left:80px;bottom:40px;';
	}else{
		$preco_dec = substr($preco, 0, 3);	
		$preco_cent = substr($preco, 3, 2);	
		$style_cent = 'font-size:50px;position:absolute;left:135px;bottom:40px;';
	}	
...
<img class="item slide-fwd-top" src="/intra/sistemas/banco-imagens/uploads/png/<?php echo $seqProduto;?>.png" style="max-height:350px; max-width:450px; -webkit-filter: drop-shadow(5px 5px 5px #222); filter: drop-shadow(5px 5px 5px #222);">
